...
export const translations: Record<Language, Translations> = {
  ...
  'zh-CN': {
    ...
    helpModeGuideTitle: '该怎么选模式？',
    helpModeGuideSide: '并排对比：适合精确逐行核对。',
    helpModeGuideInline: '内联对比：适合快速查看新增/删除。',
    helpModeGuideTree: '树状视图：适合查看结构层级与节点变更。',
    helpModeGuideSchema: 'Schema 视图：适合表/字段定义与元数据差异。',
    helpCommonMistakesTitle: '常见误解',
    helpCommonMistakeMissingInputs: '并排/内联视图都需要同时提供 XML A 和 B。',
    helpCommonMistakeInlineModified: '内联视图不会显示“修改”，而是拆成删除 + 新增。',
    helpCommonMistakeSchema: 'Schema 视图关注结构，不是逐行差异。',
